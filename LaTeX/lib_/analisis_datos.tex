...
\begin{table}[H]
    ...
    \begin{tabular}{lp{0.6\linewidth}}
        ...
        \midrule
        sol1 & Calificación en la primera evaluación (0-7) \\
        exitosos & Número de preguntas correctas en la guía \\
        fallidos & Intentos realizados en la guía \\
...
En el análisis de datos, es importante comprender las características estadísticas de las variables numéricas. En este contexto, hemos examinado la variable \say{sol1} y recopilado estadísticas como el recuento, la media, la desviación estándar, los cuartiles y el sesgo. Estos valores nos proporcionan información sobre la distribución y la tendencia central de la variable.
...
El histograma con curva de densidad es una herramienta visual importante en el análisis de datos para comprender la distribución de los valores de la variable \say{sol1}.
...
En el eje Y se presentan los valores de densidad que van desde 0.00 hasta aproximadamente 0.35, representando la densidad de la variable \say{sol1}. Por otro lado, en el eje X se muestran los valores del 0 al 7, que representan las diferentes notas obtenidas en la columna \say{sol1} (solemne 1).
...
Observando los valores atípicos en la tabla \ref{tab:valores_atipicos}, podemos notar que algunas observaciones difieren significativamente en al menos una de las variables. exitosos representa las respuestas correctas de la guía, fallidos indica la cantidad de errores para lograr los exitosos, programa al que pertenece. \say{sol1} se refiere a la nota obtenida en la solemne, aprobado se refiere si la nota de solemen es mayor mayor o igual a 4 el alumno es aprobado(columna agregada por medio de script). Estos valores atípicos pueden ser de interés para un análisis más detallado, ya que podrían indicar situaciones excepcionales o errores en la recolección de datos.