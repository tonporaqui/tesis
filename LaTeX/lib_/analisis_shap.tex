...
\begin{itemize}
    ...
    \item La variable \say{fallidos} tienen un sesgo de informacion algo disperso, pero a su vez tambien es una variable bastante interesantes de revisar.
    \item La variable \say{e42} tiene un un conjunto de datos bastante marcado entre  sus colores \say{azul} y \say{rojo}.
    \item La variable \say{e3} tiene un un conjunto de datos bastante marcado entre  sus colores \say{azul} y \say{rojo}.
\end{itemize}
...
En la Figura \ref{fig:dependencia_hito1} se muestra el gráfico de dependencia para la variable \say{hito1}. mientras tanto en la figura \ref{fig:dependencia_e29} se muestra el gráfico de dependencia para la variable \say{e29}
...
En la Figura \ref{fig:dependencia_exitosos} se muestra el gráfico de dependencia para la variable \say{exitosos}, mientras tanto en la figura \ref{fig:dependencia_fallidos} se muestra el gráfico de dependencia para la variable \say{fallidos}
...
En la Figura \ref{fig:dependencia_e42} se muestra el gráfico de dependencia para la variable \say{e42}, mientras tanto en la figura \ref{fig:dependencia_e3} se muestra el gráfico de dependencia para la variable \say{e3}
